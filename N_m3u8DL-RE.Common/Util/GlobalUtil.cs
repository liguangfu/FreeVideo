...
public class GlobalUtil
{
    ...
    {
        var fileExt = OperatingSystem.IsWindows() ? ".exe" : ".aar";
        var searchPath = new[] {Path.Combine(Environment.CurrentDirectory, "app/ffmpeg"),Path.Combine(Path.GetDirectoryName(Environment.ProcessPath),"app") };
